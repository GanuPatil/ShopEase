    ...
    return ( <
            ...
            navigation.categories.map((category) => ( <
                ...
                div className = "grid grid-cols-2 gap-x-4" > {
                    category.featured.map((item) => ( <
                        ...
                        className = "absolute inset-0 z-10" / > { item.name } <
                        /a> <
                        p ariahidden = "true"
                        className = "mt-1" >
                        Shop now <
                ...
                /div> {
                    category.sections.map((section) => ( <
                        ...
                        /p> <
                        ul role = "list"
                        arialabelledby = { `${category.id}-${section.id}-heading-mobile` }
                        className = "mt-6 flex flex-col space-y-6" >
                        {
                            section.items.map((item) => ( <
                                ...
                                <
                                a href = { item.href }
                                className = "-m-2 block p-2 text-gray-500" > { item.name } <
                                /a> <
                                /li>
                            ))
                        } <
        ...
        div className = "space-y-6 border-t border-gray-200 px-4 py-6" > {
            navigation.pages.map((page) => ( <
                ...
                <
                a href = { page.href }
                className = "-m-2 block p-2 font-medium text-gray-900" > { page.name } <
                /a> <
                /div>
            ))
        } <
        ...
        div className = "flex h-full space-x-8" > {
            navigation.categories.map((category) => ( <
                ...
                <
                PopoverButton className = "relative z-10 -mb-px flex items-center border-b-2 border-transparent pt-px text-sm font-medium text-gray-700 transition-colors duration-200 ease-out hover:text-gray-800 data-[open]:border-indigo-600 data-[open]:text-indigo-600" > { category.name } <
                /PopoverButton> <
                /div>
                ...
                div className = "row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm" > {
                    category.sections.map((section) => ( <
                        ...
                        /p> <
                        ul role = "list"
                        arialabelledby = { `${section.name}-heading` }
                        className = "mt-6 space-y-6 sm:mt-4 sm:space-y-4" >
                        {
                            section.items.map((item) => ( <
                                ...
                                <
                                a href = { item.href }
                                className = "hover:text-gray-800" > { item.name } <
                                /a> <
                                /li>
                            ))
                        } <
        ...
        MagnifyingGlassIcon ariahidden = "true"
        className = "h-6 w-6" / >
        <
        /a> <
        /div>
        ...
        <
        ShoppingBagIcon ariahidden = "true"
